<?php 
    ...
    $result = mysqli_query($conn, "SELECT * FROM tb_parameter ORDER BY id_parameter DESC LIMIT 4");   
...
<head>
    ...
    <title>Healthyricefield - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Healthyricefield </div>
            </a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                <h4>Nilai pH</h4></div>
<?php  $nilai_ph = mysqli_query($conn, "SELECT persen_ph FROM tb_parameter ORDER BY id_parameter DESC");  ?>
...
{
    setTimeOut(function(){
        $('.text').fadeOut('slow').load('sb.php').fadeIn('slow');
    refresh();
}, 300);
}
</script>
